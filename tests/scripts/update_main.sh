...
# in order to expand the kactl macros, you need to have the actual macros copy-pasted at the beginning of each .hpp file
sed --in-place "1,/^/r library_checker_aizu_tests/kactl_macros.hpp" ../library/**/*.hpp
