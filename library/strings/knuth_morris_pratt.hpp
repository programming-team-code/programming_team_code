...
//! rotationally equivalent: run kmp with one array as the
//! needle and the other array doubled (excluding the first
//! & last characters) as the haystack or just use kactl's
//! min rotation code.
