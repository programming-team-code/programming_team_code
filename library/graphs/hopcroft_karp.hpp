...
//!     auto [size_of_matching, l_to_r, r_to_l, mvc_l,
//!     mvc_r] = hopcroft_karp(adj, rsz);
//! @endcode
struct hopcroft_karp {
  int size_of_matching =
      0;  //!< # of edges in max matching (which = size of
          //!< min vertex cover by König's theorem)
  ...
  vi l_to_r, r_to_l;
  //! @}
  //! mvc_l[node_left] = 1 iff node_left is in the min
  //! vertex cover; ditto mvc_r[node_right] mvc_l[node_left]
  //! = 0 iff node_left is in the max independent set
  //! @{
